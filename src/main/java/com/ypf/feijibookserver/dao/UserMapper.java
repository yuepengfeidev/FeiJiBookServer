...
public interface UserMapper {
    ...
    AdminBean adminLogin(String name);
    List<UserInfoBean> getUser();

    DetailRecordBean findRecord(DetailRecordBean detailRecordBean);

    void updateDataModel(DataModelBean modelBean);

    YearExpendBean getYearExpend(YearExpendBean yearExpendBean);

    void updateYearExpend(YearExpendBean yearExpendBean);

    void insertYearExpend(YearExpendBean yearExpendBean);

    void deleteYearExpend(YearExpendBean yearExpendBean);

    MonthExpendBean getMonthExpend(MonthExpendBean monthExpendBean);

    void updateMonthExpend(MonthExpendBean monthExpendBean);

    void insertMonthExpend(MonthExpendBean monthExpendBean);

    void deleteMonthExpend(MonthExpendBean monthExpendBean);

    List<Map<String,Object>> getMainProportion(int year);

    List<Map<String,Object>> getExpendTrend(int year);

    List<Map<String,Object>> getMonthRecord(MonthRecordBean monthRecordBean);

    List<Map<String,Object>> getDayRecord(MonthRecordBean monthRecordBean);

    DataModelBean getDataModel();
    /**
     * 设置该用户的
     *
     * @param portrait
