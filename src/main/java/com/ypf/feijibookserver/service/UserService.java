...
public interface UserService {
    ...
    String getUser();
    String updateDataModel(DataModelBean modelBean);
    String getDataModel();

     String  getMainProportion();

     String getExpendTrend();

     void disposeYearMonthRecord(DetailRecordBean detailRecordBean ,String dispose);

     String getUserRecord(String account);

     String getExpendIntroduce();
}
